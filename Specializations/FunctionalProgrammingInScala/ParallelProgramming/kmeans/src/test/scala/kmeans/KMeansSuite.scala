...
class KMeansSuite extends FunSuite {
  ...
  test("'classify' should work for 'points' == GenSeq(Point(1, 1, 0), Point(1, -1, 0), Point(-1, 1, 0), Point(-1, -1, 0)) and 'means' == GenSeq(Point(0, 0, 0))") {
  ...
  test("'classify' should work for 'points' == GenSeq(Point(1, 1, 0), Point(1, -1, 0), Point(-1, 1, 0), Point(-1, -1, 0)) and 'means' == GenSeq(Point(1, 0, 0), Point(-1, 0, 0))") {
    val p1 = new Point(1, 1, 0)
    val p2 = new Point(1, -1, 0)
    val p3 = new Point(-1, 1, 0)
    val p4 = new Point(-1, -1, 0)
  ...
  test("'classify' with data parallelism should work for empty 'points' and empty 'means'") {
    val points: GenSeq[Point] = ParSeq()
    val means: GenSeq[Point] = ParSeq()
  ...
  test("'classify' with data parallelism should work for 'points' == GenSeq(Point(1, 1, 0), Point(1, -1, 0), Point(-1, 1, 0), Point(-1, -1, 0)) and 'means' == GenSeq(Point(1, 0, 0), Point(-1, 0, 0))") {
    val p1 = new Point(1, 1, 0)
    val p2 = new Point(1, -1, 0)
    val p3 = new Point(-1, 1, 0)
    val p4 = new Point(-1, -1, 0)
    val points: GenSeq[Point] = ParSeq(p1, p2, p3, p4)

    val mean1 = new Point(1, 0, 0)
    val mean2 = new Point(-1, 0, 0)
    val means: GenSeq[Point] = ParSeq(mean1, mean2)
